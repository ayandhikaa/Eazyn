...
$query = "select izin.*, guru.nama as nama_guru, bk.nama as nama_bk 
          ...
          where siswa_id=2";
          // tips:jalankan query di phpmyadmin untuk ujicoba sql
// 3. menjaankan query
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    <a href="./authentication-loginphp" class="btn btn-outline-primary mx-3 mt-2 d-block">Logout</a>
                  </div>
                </div>
              </li>
            </ul>
      ...
      <div class="container-fluid">
        <!--  Row 1 -->
        <span class="fs-2 fw-semibold">Form izin terakhir :</span>
        <br>
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <div class="mb-4">
                  <h5 class="card-title fw-semibold">Riwayat izin bulan Maret</h5>
                </div>
